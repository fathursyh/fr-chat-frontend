<template>
  ...
  >
    ...
    >
      ...
      <button
        v-if="postData.userId._id === User.state.userData.id && editable"
        @click="emits('onEdit')"
        type="button"
      ...
      <button
      v-if="postData.userId._id === User.state.userData.id"
...
const props = defineProps({
  ...
  postData: {type: [Object, Array], required: true},
})
const emits = defineEmits(['onLike', 'closeMenu', 'onEdit', 'onDelete'])
const liked = computed(() => {
  return props.postData.likes.some(
